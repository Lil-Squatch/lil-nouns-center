...
const proposals = () => {
  return (
    <>
      <PageHeader>
        <Header title="Proposals | Lil Nouns Center" />
        <Title title="Funding: Proposals" />

        <Subheader
          title="For Projects needing 10-100Ξ"
          body="Resources allocated for the long-term growth of the Lil Nouns project. Larger in scope and undergo more scruntiny."
        />
      </PageHeader>
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-6">
              <div className="md:ml-auto md:w-1/2 md:pl-10">
                ...
                <div className="mt-8 flex gap-4">
                  <Button
                    text={"Post An Idea"}
                    link="https://discourse.lilnouns.wtf/"
                  />
                  <Button
                    text={"Past Proposals"}
                    link="https://lilnouns.wtf/vote"
                  />
                </div>
              </div>
            </div>
