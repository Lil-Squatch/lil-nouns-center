...
const Footer = () => {
  ...
  return (
    <div className="relative xs:px-6 sm:px-0 text-black font-medium gap-2 items-center w-full flex flex-col text-center">
      {asPath === "/" && (
        <p>
          Lil Nouns Center serves as the knowledge center &#38; resource hub for
          Lil Nouns DAO
        </p>
      )}
      ...
      <div className="flex gap-8 items-center">
        {/* Twitter */}
        <a href="https://twitter.com/lilnounsdao" target="_blank" rel="noreferrer">
          <svg
        ...
        {/* Discord */}
        <a href="https://discord.gg/xjARUcB3tJ" target="_blank" rel="noreferrer">
          <svg
        ...
        {/* Discourse */}
        <a href="https://discourse.lilnouns.wtf/" target="_blank" rel="noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -1 104 106"
